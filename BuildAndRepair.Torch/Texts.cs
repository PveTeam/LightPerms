...
public static class Texts
{
    ...
    static Texts()
    {
        ...
        Mod.Log.Write(Logging.Level.Event, "Localization: Disabled={0} Language={1}", Mod.DisableLocalization, language);
    ...
    {
        return LocalizationHelper.GetTexts(language, GetDictionaries());
    }
        ...
        var dicts = new Dictionary<MyLanguagesEnum, Dictionary<string, string>>
        {
            ...
            },
            {
                MyLanguagesEnum.German, new Dictionary<string, string>
                {
                    ...
                    {
                        "GrindPriority_Tooltip",
                        "Schlaltet das Demontieren des selektierten Blocktypes ein/aus und legt die Priorität fest.\n(Wenn das Demontieren per festgelegter Farbe erfolgt, wird die Priorät und die Freigabe ignorierd)"
                    },
